...
Welcome to the Book Store web application! This project aims to provide an online platform for browsing, managing, and purchasing books. This README will guide you through setting up the application and understanding its structure.
...
**individual book state, as well as a button to delete the book**
**a list to renders individual books**
**a form to create new books**
**a navigation to link to the 2 routes you created**
...
```sh
git git@github.com:Nessrine88/Bookstore.git
```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Nessrine88/Bookstore/issues).
